...
export default function MaifPage() {
  ...
  const content = {
    en: {
      ...
      arenaText: "Högelid Idrottsplats is a classic sports facility located in the heart of Mariestad. The venue offers excellent conditions for athletics competitions with modern equipment and good facilities. The atmospheric environment creates a perfect arena for elite-level high jumping.",
    ...
    no: {
      ...
      arenaTitle: "Arena: Högelid Idrottsplats",
      arenaText: "Högelid Idrottsplats er et klassisk idrettsanlegg som ligger i hjertet av Mariestad. Anlegget tilbyr utmerkede forhold for friidrettsstevner med moderne utstyr og gode fasiliteter. Det atmosfæriske miljøet skaper en perfekt arena for høydehopp på elitenivå.",
    ...
    sv: {
      ...
      arenaTitle: "Arena: Högelid Idrottsplats",
      arenaText: "Högelid Idrottsplats är en klassisk idrottsanläggning belägen i hjärtat av Mariestad. Anläggningen erbjuder utmärkta förutsättningar för friidrottstävlingar med modern utrustning och goda anläggningar. Den atmosfäriska miljön skapar en perfekt arena för höjdhopp på elitnivå.",
      cityTitle: "Om Mariestad",
